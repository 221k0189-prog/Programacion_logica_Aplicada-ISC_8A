...
#    R: Una función se puede tratar como cualquiera otra variable,
#       se guarda y pasan agumentos, asi como devolver en otras funciones y valiables.
#
# 2. ¿Cuál es la diferencia entre una función de orden superior y un callback?
#    R: Una función de orden superior es la que recibe o devuelve funciones y el callback
#       es la función que se pasa como argumento para que se ejecute dentro de otra.
#
# 3. ¿Cuándo conviene usar comprensión de listas en lugar de un ciclo for?
#    R: Cuando queremos utilizar o crear una lista de forma mas corta, clara y rapida.
#
# 4. ¿Qué hace map() y cómo se relaciona con lambda?
#    R: Aplica una función a cada elemento de una lista, lambda nos permite
#       crear funciones pequeñas sin definirlas formalmente.
#
# 5. ¿Qué ventaja ofrece pasar una función como argumento a otra función?
#    R: Hace qie el códigpp se mas reutilizable y mas flexible.
# ─────────────────────────────────────────────────────────────────────────────
...
#         R: tomar_orden(), porque recibira otra funcion (callback)
#
#      - ¿Dónde usarás comprensión de listas?
#         R: se utilizara para genrar las porciones, en la funcion  tomar_orden()
#
#      - ¿Dónde usarás lambda + map()?
#         R: Lo usariamos para calcular los precios.
# ─────────────────────────────────────────────────────────────────────────────
...
#
# Registra:
#   - ¿El resultado coincide con lo esperado? ✅, si
#   - Si no coincide, ¿en qué función está el error? No cuentaa con algun error.
#   - ¿Qué cambiarías para corregirlo? Como no tiene algun error, no se cambiaria nada o seria modificación.
# ─────────────────────────────────────────────────────────────────────────────
...
funcion = elegir_producto("pizza")
orden = tomar_orden(funcion, 3, 25)
print("\nTotal a pagar:", calcular_total(orden[1]))
